...
for nSlice = sliceRange % comment if you need to check 1 slice
    ...
    %% Feature extraction
    featuresTemp = struct('Presence', [], 'Area', [], ... 
    ...
    featuresFill = regionprops(Lfill,  img, {'Area', 'PixelValues', 'Eccentricity', ...
                                             'Orientation', 'MajorAxisLength', 'MinorAxisLength', ... 
                                             'EquivDiameter', 'MaxIntensity', 'MeanIntensity', ...
                                             'MinIntensity', 'Extrema', 'BoundingBox',...
